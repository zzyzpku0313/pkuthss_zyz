...
\begin{enumerate}[itemindent=0.3em]     % 用enumerate环境可能需要控制缩进量
    \item \texttt{mathpix}：识别公式准确，但有识别数量的免费限额，可能要收费使用。下载地址：\url{https://mathpix.com/}。
    \item \texttt{simpletex}：识别公式基本准确，对“粗体”、“正体”等的识别相对较差（例如$x$、$\mathrm{x}$、$\mathbf{x}$），需手动调整，但免费。下载地址：\url{https://simpletex.cn/}。
\end{enumerate}
