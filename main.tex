...
%*********************************************************************
% pkuthss_zyz: 北京大学研究生学位论文模板 ZYZ先生的使用心得
% 2024/06/15
%
% 重要提示：
%   1. 当前模板基于pkuthss v1.9.2，也参考了pkuthss v1.9.4和北京大学工学院的LaTex模板
...
\documentclass[UTF8,fontset=auto,ugly,language=chinese]{pkuthss}
